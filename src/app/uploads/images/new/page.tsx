...
export default function NewImagePage() {
  ...
  async function onSubmit(data: z.infer<typeof FormSchema>) {
    ...
    const resp = await axios.post(
      `${process.env.NEXT_PUBLIC_URL}/images/singleimagefile`,
      data,
      {
    ...
    if (resp.status === 201 && resp.statusText === "Created") {
      ...
      toast({
        title: "Success",
        description: `Image successfully submitted`,
      });
    } else {
      console.log(resp);
      setLoading(false);
      ...
      toast({
        title: "Failure",
        description: "Image doesn't get submitted please upload it properly",
        variant: "destructive",
      });
    }
  }
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Upload the image file of any format
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
